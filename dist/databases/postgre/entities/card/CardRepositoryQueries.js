...
exports.GET_DESK_CARDS = exports.GET_DESK_DETAILS = exports.GET_DESK_SUBS_BY_CREATOR_SUB = exports.GET_ARCHIVED_DESKS_BY_CREATOR_SUB = exports.GET_DESKS_BY_CREATOR_SUB = exports.GET_CARD_SUBS_FOR_PLAY = exports.GET_CARDS = exports.INSERT_DESK_SETTINGS = exports.GET_ROOT_FOLDERS = exports.GET_FOLDER_INFO = exports.GET_FOLDER_CONTENTS = exports.GET_FOLDER_TREE = exports.HAVE_ACCESS_TO_FOLDER = exports.ADD_DESK_TO_FOLDER = exports.EXIST_FOLDER_BY_SUB = exports.INSERT_FOLDER = exports.INSERT_DESK = exports.DELETE_CARD = exports.RESTORE_DESK = exports.ARCHIVE_DESK = exports.GET_CARD = exports.UPDATE_CARD = exports.UPDATE_FEED_CARD_ORIENTATION = exports.UPDATE_DESK = exports.UPDATE_DESK_SETTINGS = exports.HAVE_ACCESS_TO_CARD = exports.HAVE_ACCESS_TO_DESK = exports.UPDATE_LAST_TIME_PLAYED_DESK = exports.EXIST_FOLDER_WITH_THIS_TITLE = exports.EXIST_FOLDER_WITH_THIS_TITLE_AND_PARENT = exports.EXIST_DESK_WITH_THIS_TITLE_AND_FOLDER = exports.EXIST_DESK_WITH_THIS_TITLE = exports.EXIST_DESK = exports.EXIST_CARD_BY_SUB = exports.EXIST_CARD = exports.INSERT_CARD = void 0;
exports.INSERT_CARD = `
...
`;
exports.EXIST_DESK_WITH_THIS_TITLE = `
  SELECT EXISTS (
    SELECT 1 
    FROM cards.desk d
...
`;
exports.EXIST_DESK_WITH_THIS_TITLE_AND_FOLDER = `
  SELECT EXISTS (
    SELECT 1 
    FROM cards.desk d
    INNER JOIN cards.folder_desk fd ON fd.desk_sub = d.sub
...
`;
exports.EXIST_FOLDER_WITH_THIS_TITLE_AND_PARENT = `
  SELECT EXISTS (
    SELECT 1 
    FROM cards.folder
    WHERE title = $1
...
`;
exports.EXIST_FOLDER_WITH_THIS_TITLE = `
  SELECT EXISTS (
    SELECT 1 
    FROM cards.folder
    WHERE title = $1
